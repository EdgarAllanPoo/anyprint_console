...
namespace AnyPrintConsole
{
    public partial class Form1 : Form
    {
        ...
        private void ResizeLogo()
        {
            ...
            // Make logo wide and dominant
            int logoWidth = (int)(screenWidth * 0.65);

            // Calculate height from actual image ratio
